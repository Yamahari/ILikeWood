...
)
{
    ...
    public static final ILikeWoodConfig CRATE_CONFIG = make(Constants.CRATE_PLURAL);
    ...
    public static Stream<ILikeWoodConfig> getAll()
    {
        return Stream.of(PANELS_CONFIG, PANELS_STAIRS_CONFIG, PANELS_SLABS_CONFIG, BARRELS_CONFIG, BEDS_CONFIG, BOOKSHELVES_CONFIG, COMPOSTERS_CONFIG,
            ...
            ITEM_FRAMES_CONFIG, AXES_CONFIG, HOES_CONFIG, PICKAXES_CONFIG, SHOVELS_CONFIG, SWORDS_CONFIG, CAMPFIRE_CONFIG, PAINTING_CONFIG, CRATE_CONFIG
        );
    }
