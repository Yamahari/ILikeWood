...
public final class VanillaWoodenItemTiers
{
    public static final IWoodenItemTier ACACIA = new DefaultWoodenItemTier(VanillaWoodTypes.ACACIA,
        Constants.MOD_ID,
        Constants.ACACIA,
        () -> Ingredient.of(VanillaPlugin.BLOCK_REGISTRY.getObject(VanillaWoodTypes.ACACIA, WoodenBlockType.PANELS))
    );

    public static final IWoodenItemTier BIRCH = new DefaultWoodenItemTier(VanillaWoodTypes.BIRCH,
        Constants.MOD_ID,
        Constants.BIRCH,
        () -> Ingredient.of(VanillaPlugin.BLOCK_REGISTRY.getObject(VanillaWoodTypes.BIRCH, WoodenBlockType.PANELS))
    );

    public static final IWoodenItemTier CRIMSON = new DefaultWoodenItemTier(VanillaWoodTypes.CRIMSON,
        Constants.MOD_ID,
        Constants.CRIMSON,
        () -> Ingredient.of(VanillaPlugin.BLOCK_REGISTRY.getObject(VanillaWoodTypes.CRIMSON, WoodenBlockType.PANELS))
    );

    public static final IWoodenItemTier DARK_OAK = new DefaultWoodenItemTier(VanillaWoodTypes.DARK_OAK,
        Constants.MOD_ID,
        Constants.DARK_OAK,
        () -> Ingredient.of(VanillaPlugin.BLOCK_REGISTRY.getObject(VanillaWoodTypes.DARK_OAK, WoodenBlockType.PANELS))
    );

    public static final IWoodenItemTier JUNGLE = new DefaultWoodenItemTier(VanillaWoodTypes.JUNGLE,
        Constants.MOD_ID,
        Constants.JUNGLE,
        () -> Ingredient.of(VanillaPlugin.BLOCK_REGISTRY.getObject(VanillaWoodTypes.JUNGLE, WoodenBlockType.PANELS))
    );

    public static final IWoodenItemTier MANGROVE = new DefaultWoodenItemTier(VanillaWoodTypes.MANGROVE,
        Constants.MOD_ID,
        Constants.MANGROVE,
        () -> Ingredient.of(VanillaPlugin.BLOCK_REGISTRY.getObject(VanillaWoodTypes.MANGROVE, WoodenBlockType.PANELS))
    );

    public static final IWoodenItemTier OAK = new DefaultWoodenItemTier(VanillaWoodTypes.OAK,
        Constants.MOD_ID,
        Constants.OAK,
        () -> Ingredient.of(VanillaPlugin.BLOCK_REGISTRY.getObject(VanillaWoodTypes.OAK, WoodenBlockType.PANELS))
    );

    public static final IWoodenItemTier SPRUCE = new DefaultWoodenItemTier(VanillaWoodTypes.SPRUCE,
        Constants.MOD_ID,
        Constants.SPRUCE,
        () -> Ingredient.of(VanillaPlugin.BLOCK_REGISTRY.getObject(VanillaWoodTypes.SPRUCE, WoodenBlockType.PANELS))
    );
