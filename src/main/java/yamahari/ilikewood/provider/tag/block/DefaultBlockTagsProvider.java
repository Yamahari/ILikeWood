...
public class DefaultBlockTagsProvider extends AbstractBlockTagsProvider {
    ...
    public DefaultBlockTagsProvider(final DataGenerator generator, final CompletableFuture<HolderLookup.Provider> lookupProvider, final ExistingFileHelper existingFileHelper, final String root, final WoodenBlockType blockType, final TagKey<Block> tag) {
