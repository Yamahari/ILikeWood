...
public final class BarrelItemTagsProvider extends DefaultBlockItemTagsProvider {
    public BarrelItemTagsProvider(final DataGenerator generator, final CompletableFuture<HolderLookup.Provider> lookupProvider, final ExistingFileHelper existingFileHelper) {
        super(generator, lookupProvider, existingFileHelper, Constants.BARREL_PLURAL, WoodenBlockType.BARREL, ILikeWoodItemTags.BARRELS);
    }
