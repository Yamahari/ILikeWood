...
public final class ChestItemTagsProvider extends DefaultBlockItemTagsProvider {
    public ChestItemTagsProvider(final DataGenerator generator, final CompletableFuture<HolderLookup.Provider> lookupProvider, final ExistingFileHelper existingFileHelper) {
        super(generator, lookupProvider, existingFileHelper, Constants.CHEST_PLURAL, WoodenBlockType.CHEST, ILikeWoodItemTags.CHESTS);
    }
