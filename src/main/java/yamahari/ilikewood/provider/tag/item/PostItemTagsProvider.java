...
public final class PostItemTagsProvider extends AbstractItemTagsProvider {
    public PostItemTagsProvider(final DataGenerator generator, final CompletableFuture<HolderLookup.Provider> lookupProvider, final ExistingFileHelper existingFileHelper) {
