...
public final class TorchItemTagsProvider extends AbstractItemTagsProvider {
    public TorchItemTagsProvider(final DataGenerator generator, final CompletableFuture<HolderLookup.Provider> lookupProvider, final ExistingFileHelper existingFileHelper) {
