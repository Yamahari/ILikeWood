...
public class LogPileRecipeProvider extends AbstractBlockItemRecipeProvider {
    ...
    protected void registerRecipes(@Nonnull final Consumer<FinishedRecipe> consumer, final IWoodType woodType, final Block block) {
        ...
        final RecipeBuilder builder = ShapedRecipeBuilder.shaped(RecipeCategory.DECORATIONS, block, 2)
            .define('I', post)
            .pattern("II")
            .pattern("II")
        ...
        builder.save(consumer, Objects.requireNonNull(ForgeRegistries.BLOCKS.getKey(block)));
    }
}