...
public final class WoodTypes {
    public static final WoodType ACACIA = new WoodType(
            ...
            ILikeWoodConfig.SERVER_CONFIG.ENCHANTING_POWER_BONUS.get(Constants.ACACIA)::get);

    public static final WoodType BIRCH = new WoodType(
            Constants.BIRCH,
            createWoodTypeProperties(Constants.BIRCH),
            ILikeWoodConfig.SERVER_CONFIG.ENCHANTING_POWER_BONUS.get(Constants.BIRCH)::get);

    public static final WoodType DARK_OAK = new WoodType(
            Constants.DARK_OAK,
            createWoodTypeProperties(Constants.DARK_OAK),
            ILikeWoodConfig.SERVER_CONFIG.ENCHANTING_POWER_BONUS.get(Constants.DARK_OAK)::get);

    public static final WoodType JUNGLE = new WoodType(
            Constants.JUNGLE,
            createWoodTypeProperties(Constants.JUNGLE),
            ILikeWoodConfig.SERVER_CONFIG.ENCHANTING_POWER_BONUS.get(Constants.JUNGLE)::get);

    public static final WoodType OAK = new WoodType(
            Constants.OAK,
            createWoodTypeProperties(Constants.OAK),
            ILikeWoodConfig.SERVER_CONFIG.ENCHANTING_POWER_BONUS.get(Constants.OAK)::get);

    public static final WoodType SPRUCE = new WoodType(
            Constants.SPRUCE,
            createWoodTypeProperties(Constants.SPRUCE),
            ILikeWoodConfig.SERVER_CONFIG.ENCHANTING_POWER_BONUS.get(Constants.SPRUCE)::get);
    ...
    private static Map<String, WoodType.Properties> createWoodTypeProperties(final String woodType) {
        return ILikeWoodConfig.SERVER_CONFIG.BURN_TIME.get(woodType).entrySet().stream()
