...
public final class Util {
    ...
    public static String toRegistryName(final String... elements) {
        return Arrays.stream(elements).filter(Objects::nonNull).filter(Predicate.not(String::isEmpty)).collect(Collectors.joining("_"));
    }

    public static String toComponentName(final String... elements) {
        return Arrays.stream(elements).filter(Objects::nonNull).filter(Predicate.not(String::isEmpty)).collect(Collectors.joining("."));
    }
    ...
    private static String toTranslationNameImpl(final String registryName) {
        return Arrays.stream(StringUtils.split(registryName, '_'))
    ...
    public static int[] createColorShades(final RGBColor rgb, final int n, final float min, final float max) {
    ...
    public static Map<Integer, Integer> createShadeColorMap(final DyeColor dyeColor, final int[] colors) {
