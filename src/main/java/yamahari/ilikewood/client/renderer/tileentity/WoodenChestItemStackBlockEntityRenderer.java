...
public final class WoodenChestItemStackBlockEntityRenderer extends BlockEntityWithoutLevelRenderer {
    ...
    @Override
    public void renderByItem(final ItemStack itemStack, @Nonnull final ItemDisplayContext itemDisplayContext, @Nonnull final PoseStack matrixStack, @Nonnull final MultiBufferSource buffer, final int combinedLight, final int combinedOverlay) {
