...
public final class WoodenWorkBenchContainer extends WorkbenchContainer {
    ...
    public WoodenWorkBenchContainer(final int windowId, final PlayerInventory inventory, final IWorldPosCallable callable) {
    ...
    public boolean canInteractWith(@SuppressWarnings("NullableProblems") final PlayerEntity player) {
        return this.worldPosCallable.applyOrElse((world, blockPos) -> {
            ...
            return WoodenBlocks.getBlocks(WoodenObjectType.CRAFTING_TABLE).anyMatch(blockState::isIn)
