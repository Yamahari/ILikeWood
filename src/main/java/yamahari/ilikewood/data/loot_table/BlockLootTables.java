...
public final class BlockLootTables extends net.minecraft.data.loot.BlockLootTables {
    ...
    protected void addTables() {
        WoodenBlocks.getBlocks(WoodenObjectType.SLAB)
                .forEach(block -> this.registerLootTable(block, net.minecraft.data.loot.BlockLootTables::droppingSlab));
        ...
        WoodenBlocks.getBlocks(WoodenObjectType.BARREL, WoodenObjectType.CHEST, WoodenObjectType.LECTERN)
                .forEach(block -> this.registerLootTable(block, net.minecraft.data.loot.BlockLootTables::droppingWithName));
