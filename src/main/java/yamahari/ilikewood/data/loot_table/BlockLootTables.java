...
public final class BlockLootTables extends net.minecraft.data.loot.BlockLootTables {
    ...
    protected void addTables() {
        ...
        WoodenBlocks.getBlocks(WoodenObjectType.PANELS, WoodenObjectType.STAIRS, WoodenObjectType.WALL, WoodenObjectType.LADDER, WoodenObjectType.TORCH, WoodenObjectType.CRAFTING_TABLE).forEach(this::registerDropSelfLootTable);
