...
public final class ILikeWoodBlockLootTables extends BlockLootTables {
    ...
    protected void addTables() {
        WoodenBlocks.getBlocks(WoodenObjectType.SLAB).forEach(block -> this.registerLootTable(block, BlockLootTables::func_218513_d));
        WoodenBlocks.getBlocks(WoodenObjectType.PANELS, WoodenObjectType.STAIRS).forEach(this::func_218492_c);
        WoodenBlocks.getBlocks(WoodenObjectType.BARREL, WoodenObjectType.CHEST).forEach(block -> this.registerLootTable(block, BlockLootTables::func_218481_e));
