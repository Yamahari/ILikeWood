...
public final class ObjectTypeValidator
{
    ...
    private static final List<Set<IObjectType>> DEPENDS_ON_PANELS = Collections.singletonList(Sets.newHashSet(WoodenBlockType.PANELS));
    private static final List<Set<IObjectType>> DEPENDS_ON_PANELS_SLABS = Collections.singletonList(Sets.newHashSet(WoodenBlockType.PANELS_SLAB));
    private static final List<Set<IObjectType>> DEPENDS_ON_STICKS = Collections.singletonList(Sets.newHashSet(WoodenItemType.STICK));
    ...
    private static final List<Set<IObjectType>> DEPENDS_ON_STICKS_AND_PANELS = Collections.singletonList(Sets.newHashSet(WoodenItemType.STICK, WoodenBlockType.PANELS));
    ...
    static
    {
        ...
        dependencies.put(WoodenBlockType.BARREL, Collections.singletonList(Sets.newHashSet(WoodenBlockType.PANELS, WoodenBlockType.PANELS_SLAB)));
        ...
        dependencies.put(WoodenBlockType.SAWMILL, Collections.singletonList(Sets.newHashSet(WoodenBlockType.PANELS, WoodenBlockType.LOG_PILE)));
        dependencies.put(WoodenBlockType.LECTERN, Collections.singletonList(Sets.newHashSet(WoodenBlockType.PANELS_SLAB, WoodenBlockType.BOOKSHELF)));
        dependencies.put(WoodenBlockType.LADDER, DEPENDS_ON_STICKS);
        dependencies.put(WoodenBlockType.SCAFFOLDING, DEPENDS_ON_STICKS);
        dependencies.put(WoodenBlockType.SOUL_TORCH, Collections.singletonList(Sets.newHashSet(WoodenBlockType.TORCH, WoodenItemType.STICK)));
        dependencies.put(WoodenBlockType.TORCH, Collections.singletonList(Sets.newHashSet(WoodenBlockType.SOUL_TORCH, WoodenItemType.STICK)));
        dependencies.put(WoodenBlockType.WALL_TORCH, Collections.singletonList(Sets.newHashSet(WoodenItemType.STICK, WoodenBlockType.TORCH)));
        dependencies.put(WoodenBlockType.WALL_SOUL_TORCH, Collections.singletonList(Sets.newHashSet(WoodenItemType.STICK, WoodenBlockType.SOUL_TORCH)));
        ...
        dependencies.put(WoodenBlockType.STRIPPED_POST, Collections.singletonList(Sets.newHashSet(WoodenBlockType.POST)));
        ...
        dependencies.put(WoodenBlockType.TABLE, Collections.singletonList(Sets.newHashSet(WoodenBlockType.STRIPPED_POST)));
    ...
    {
        return Objects.requireNonNull(DEPENDENCIES.get(objectType), String.format("Missing dependency set for object type \"%s\".", objectType.getName()));
    }
