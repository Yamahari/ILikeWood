...
public final class ILikeWoodTieredItemRegistry implements IWoodenTieredItemRegistry {
    ...
    @Override
    public RegistryObject<Item> getRegistryObject(final IWoodenItemTier woodenItemTier, final IWoodType woodType, final WoodenTieredItemType tieredItemType)
    ...
    @Override
    public Stream<RegistryObject<Item>> getRegistryObjects(final IWoodType woodType, final WoodenTieredItemType tieredItemType) throws IllegalArgumentException {
    ...
    @Override
    public Item getObject(final IWoodenItemTier woodenItemTier, final IWoodType woodType, final WoodenTieredItemType tieredItemType) throws IllegalArgumentException {
        return this.getRegistryObject(woodenItemTier, woodType, tieredItemType).get();
    }

    @Override
    public Stream<Item> getObjects(final IWoodType woodType, final WoodenTieredItemType tieredItemType) throws IllegalArgumentException {
