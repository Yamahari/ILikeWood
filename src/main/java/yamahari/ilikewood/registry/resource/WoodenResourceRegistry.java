...
public final class WoodenResourceRegistry implements IWoodenResourceRegistry {
    ...
    public boolean hasBlockResource(final IWoodType woodType, final WoodenBlockType blockType) {
    ...
    public boolean hasItemResource(final IWoodType woodType, final WoodenItemType itemType) {
    ...
    public IWoodenResource getBlockResource(final IWoodType woodType, final WoodenBlockType blockType) {
        return this.blockResources.get(blockType).get(woodType);
    }

    public IWoodenResource getItemResource(final IWoodType woodType, final WoodenItemType itemType) {
