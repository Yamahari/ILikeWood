...
public final class ILikeWoodBlockItemRegistry extends AbstractILikeWoodObjectRegistry<Item, WoodenBlockType> {
    ...
    private RegistryObject<Item> registerTorchBlockItem(final IWoodType woodType, final WoodenBlockType torchBlockType, final WoodenBlockType wallTorchBlockType) {
        ...
        return this.registry.register(torch.getId().getPath(), () -> new WoodenWallOrFloorItem(torchBlockType, torch.get(), wallTorch.get(), new Item.Properties()));
    }
