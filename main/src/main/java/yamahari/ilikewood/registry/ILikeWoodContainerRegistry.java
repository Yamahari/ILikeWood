...
public final class ILikeWoodContainerRegistry
{
    ...
    static
    {
        ...
        {
            WoodenContainerTypes.WOODEN_SAWMILL = REGISTRY.register("wooden_sawmill", () -> new MenuType<>(WoodenSawmillContainer::new));
        }

        if (ILikeWoodConfig.CRAFTING_TABLES_CONFIG.isEnabled())
        {
            WoodenContainerTypes.WOODEN_WORK_BENCH = REGISTRY.register("wooden_workbench", () -> new MenuType<>(WoodenWorkBenchContainer::new));
        }
    }
