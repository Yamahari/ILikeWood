...
public final class ILikeWoodMenuTypeRegistry
{
    ...
    static
    {
        ...
        {
            WoodenMenuTypes.WOODEN_SAWMILL = REGISTRY.register("wooden_sawmill", () -> new MenuType<>(WoodenSawmillMenu::new));
        }

        if (ILikeWoodConfig.CRAFTING_TABLES_CONFIG.isEnabled())
        {
            WoodenMenuTypes.WOODEN_WORK_BENCH = REGISTRY.register("wooden_workbench", () -> new MenuType<>(WoodenWorkBenchMenu::new));
        }

        if (ILikeWoodConfig.CRATE_CONFIG.isEnabled())
        {
            WoodenMenuTypes.WOODEN_CRATE = REGISTRY.register("wooden_crate", () -> new MenuType<>(WoodenCrateMenu::new));
        }
    }
