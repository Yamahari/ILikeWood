...
public final class VanillaWoodTypes {
    private static final int[] ACACIA_COLORS = new int[]{
        ...
        color(186, 99, 55),
        color(194, 109, 63)};
    public static final IWoodType ACACIA =
        new DefaultWoodType(Constants.MOD_ID, Constants.ACACIA, new IWoodType.Colors(ACACIA_COLORS));
    ...
    private static final int[] BIRCH_COLORS = new int[]{
        ...
        color(215, 193, 133),
        color(215, 203, 141)};
    public static final IWoodType BIRCH =
        new DefaultWoodType(Constants.MOD_ID, Constants.BIRCH, new IWoodType.Colors(BIRCH_COLORS));
    ...
    private static final int[] CRIMSON_COLORS = new int[]{
        ...
        color(126, 58, 86),
        color(134, 62, 90)};
    public static final IWoodType CRIMSON =
        new DefaultWoodType(Constants.MOD_ID, Constants.CRIMSON, new IWoodType.Colors(CRIMSON_COLORS));
    ...
    private static final int[] DARK_OAK_COLORS = new int[]{
        ...
        color(79, 50, 24),
        color(83, 56, 26)};
    public static final IWoodType DARK_OAK =
    ...
    private static final int[] SPRUCE_COLORS = new int[]{
        ...
        color(130, 97, 58),
        color(136, 101, 57)};
    public static final IWoodType SPRUCE =
        new DefaultWoodType(Constants.MOD_ID, Constants.SPRUCE, new IWoodType.Colors(SPRUCE_COLORS));
    ...
    private static final int[] WARPED_COLORS = new int[]{
        ...
        color(57, 131, 130),
        color(58, 142, 140)};
    public static final IWoodType WARPED =
        new DefaultWoodType(Constants.MOD_ID, Constants.WARPED, new IWoodType.Colors(WARPED_COLORS));
