...
public final class StoolBlockStateProvider extends AbstractBlockStateProvider {
    public StoolBlockStateProvider(final DataGenerator generator, final ExistingFileHelper helper) {
    ...
    public void registerStateAndModel(final Block block) {
        ...
        final String path = Util.toPath(ModelProvider.BLOCK_FOLDER, WoodenBlockType.STOOL.getName());
