...
public final class TieredItemItemTagsProvider extends AbstractItemTagsProvider {
    ...
    public TieredItemItemTagsProvider(final DataGenerator generator, final AbstractBlockTagsProvider blockTagsProvider,
                                      final ExistingFileHelper existingFileHelper, final String root,
                                      final WoodenTieredItemType tieredItemType, final Tag.Named<Item> tag) {
